 ...
 */
public class GerenciarPostosDownload extends AsyncTask<Void, Void, Void> {

    Context context;
    int numPostos;
    ProgressBar mProgress;

    public GerenciarPostosDownload(Context context, ProgressBar mProgress){
    ...
    protected Void doInBackground(Void... params) {
        ...
        int ultimoPostoSalvoInicio = ultimoPostoSalvo();
        ...
        while(ultimoPostoSalvoInicio < numPostos)
        {
            ...
            if(res) {
                ...
                ultimoPostoSalvoInicio = ultimoPostoSalvoFinal;
    ...
    private int ultimoPostoSalvo(){
        SharedPreferences sharedPreferences = context.getSharedPreferences(Statics.SHARED_PREFERENCES_NAME, Context.MODE_PRIVATE);
        int ultimoPostoSalvo = sharedPreferences.getInt(Statics.SP_ULTIMO_POSTO_SALVO_KEY, 1);
